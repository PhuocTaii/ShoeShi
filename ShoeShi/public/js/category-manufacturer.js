...
document
  .getElementsByClassName('btn manufacturer')[0]
  .addEventListener('click', function () {
    $('#modal-manage-item').modal('toggle')
    document.getElementById('action').innerHTML = `Add new manufacturer`
  })

const btnsManu = document
